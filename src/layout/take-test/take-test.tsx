...
const TakeTest: React.FC = () => {
    ...
    const fetchTestData = async () => {
      ...
      try {
        ...
        if (response.data.status === 200) {
          ...
          const initialAnswers: UserAnswer[] = response.data.data.questionList.map((q: Question) => ({
      ...
      try {
        ...
        const submissionData = {
          ...
          answers: userAnswers.map(answer => {
            ...
            if (!question) return { questionId: answer.questionId };
          ...
          timeSpent: testData?.duration ? testData.duration - remainingTime : 0,
        };

        // Submit test results
        await axios.post(
          `${process.env.REACT_APP_SERVER_HOST}/api/test-results/submit`,
          submissionData,
          {
            headers: {
              Authorization: `Bearer ${token}`,
        ...
        navigate(`/test-results/${testData?.testId}`);
      } catch (err) {
  ...
  const renderQuestionContent = (question: Question, answer: UserAnswer | undefined) => {
    switch (question.type) {
      case 'multiple-choice':
        return (
      ...
      case 'checkbox':
        return (
          <div className={styles.optionsContainer}>
            <div 
              className={`${styles.checkboxItem} ${answer?.selectedOptions.includes('1') ? styles.selectedCheckbox : ''}`}
            ...
            <div 
              className={`${styles.checkboxItem} ${answer?.selectedOptions.includes('2') ? styles.selectedCheckbox : ''}`}
            ...
            <div 
              className={`${styles.checkboxItem} ${answer?.selectedOptions.includes('3') ? styles.selectedCheckbox : ''}`}
            ...
            <div 
              className={`${styles.checkboxItem} ${answer?.selectedOptions.includes('4') ? styles.selectedCheckbox : ''}`}
        ...
        return (
          <div className={styles.essayContainer}>
            <textarea
              ...
              onChange={(e) => handleEssayAnswer(question.questionId, e.target.value)}
        ...
        return (
          <div className={styles.fillContainer}>
            <input
              ...
              onChange={(e) => handleFillAnswer(question.questionId, e.target.value)}
              placeholder="Nhập câu trả lời của bạn vào đây..."
            />
          </div>
        );
        ...
        <div className={styles.instructionsCard}>
          ...
          <div className={styles.testInfo}>
            <div className={styles.infoItem}>
              ...
              <span className={styles.infoValue}>{testData.duration / 60} phút</span>
            </div>
            <div className={styles.infoItem}>
          ...
          <div className={styles.testDescription} dangerouslySetInnerHTML={{ __html: testData.description }} />
  ...
  const currentAnswer = userAnswers.find(a => a.questionId === currentQuestion.questionId);
      ...
      <div className={styles.testContent}>
        ...
        <div className={styles.questionNav}>
          ...
          <div className={styles.progressText}>
            Đã trả lời: {userAnswers.filter(a => a.selectedOption !== null).length}/{testData.questionList.length}
          </div>
          ...
          <div className={styles.legendContainer}>
            <div className={styles.legendItem}>
              <div className={`${styles.legendColor} ${styles.currentColor}`}></div>
              <span>Câu hiện tại</span>
            </div>
            <div className={styles.legendItem}>
              <div className={`${styles.legendColor} ${styles.answeredColor}`}></div>
              <span>Đã trả lời</span>
            </div>
            <div className={styles.legendItem}>
              <div className={`${styles.legendColor} ${styles.markedColor}`}></div>
              <span>Đánh dấu</span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.questionContainer}>
          <div className={styles.questionHeader}>
            ...
            >
              ...
              <i className={`fas fa-bookmark ${currentAnswer?.isMarked ? styles.markedIcon : ''}`}></i>
            </button>
          </div>
          
          <div className={styles.questionContent}>
            <div className={styles.questionText} dangerouslySetInnerHTML={{ __html: currentQuestion.content }} />
          ...
          <div className={styles.navigationButtons}>
            ...
            <button
              ...
              disabled={currentQuestionIndex === testData.questionList.length - 1}
            >
      ...
      {confirmSubmit && (
        <div className={styles.confirmOverlay}>
          <div className={styles.confirmDialog}>
            ...
            <p>Bạn đã trả lời {userAnswers.filter(a => a.selectedOption !== null).length}/{testData.questionList.length} câu hỏi.</p>

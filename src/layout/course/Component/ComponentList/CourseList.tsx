...
import { GET_USER_CATEGORY_LEVEL_1, GET_USER_CATEGORY_LEVEL_2, GET_USER_CATEGORY_LEVEL_3 } from "../../../../api/api";
  ...
  return (
    <div className="row g-4">
      {(courses.length === 0 || courses.every((course) => course.status === false)) ? (
        ...
        courses.map((course) =>
          course.status === true ? (
            <div key={course.id} className="col-xl-3 col-md-4">
              <div className="courses-two__item" style={{ padding: "0px" }}>
                <div className="courses-two__image image" style={{ width: "100%" }}>
                  <Link
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      if (course.id) {
                        const category = findCategory(course.id_danhmuc!);
                ...
                <div className="courses__content pt-4 " style={{ padding: "20px !important" }}>
